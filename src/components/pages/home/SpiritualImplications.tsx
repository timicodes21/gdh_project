    ...
    <Box sx={{ py: 5 }}>
      <Wrapper>
        <Box sx={{ position: "relative" }}>
          ...
          >
            What are the Spiritual Implications of Completing the Grand Temple?
          </p>
          <Grid container>
        ...
        <Box sx={{ overflowY: "scroll" }} className={classes?.scroll}>
          ...
          <Box>
            ...
            <p className="text-secondary-4 font-32 font-300 avenuex text-justify line-150">
              “I speak concerning the abode of my Father which He has commanded
              and given you the grace to build for Him. Hold not back every
              effort with your being to make this a reality. At this time, you
              cannot fathom the importance and usefulness of this building in
              your land, but I tell you, when this is done, you shall know
              heaven on earth. <br />
              <br /> This Temple shall be greater and more powerful than the one
              built by King Solomon; and the news of this shall overshadow the
              whole world. By these words of mine, I call upon you to be a

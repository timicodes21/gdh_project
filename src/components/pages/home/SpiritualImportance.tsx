    ...
    <Box sx={{ py: 5 }}>
      <Wrapper>
        <Box sx={{ position: "relative" }}>
          ...
          >
            Spiritual Importance of This Building To Mishenites, The Yoruba Race
            and The World
          </p>
          <Grid container>
        ...
        <Box sx={{ overflowY: "scroll" }} className={classes?.scroll}>
          ...
          <Box>
            ...
            <p className="text-secondary-4 font-32 font-300 avenuex text-justify line-150">
              ...
              accusations of all enemies visible and invisible, since you
              practically “live” with Him here on earth; it gives you the grace
              to seek and to fin immediately, the love and favour of the
              Almighty; it confirms to you the authority of God over all things,
              which He has given unto you. Above all, it makes you a joint heir
              rulers of the entire universe. This is a great opportunity and
              unquantified importance of the building and usage of this divine
              edifice when completed. <br />
              <br />
              That this building is situated on the Yoruba soil is great
              privilege to the race, indicating that where God dwells, the rays
              emanating from the Temple will keep at bay all wicked plans and
              intentions of everyone that opposes His will; whereGod dwells, the
              people of the area cannot lack any good thing; where God dwells,
              His Kingdom, yea His desired reign shall supersede over the land.
              These are great blessings for the race and her people. <br />
              <br />
              ...
              will, thereby making the world a better place for all to live in.{" "}
              <br />
              <br />
              His Kingdom on earth shall have it’s right of place to fulfil His
              divine intentions for humanity. Gabriel.” Anael.
            </p>
          </Box>
        </Box>
      </CustomModal>
